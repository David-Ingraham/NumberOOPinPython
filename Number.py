...
class Number(ABC):  # an abstract class
    ...
    @abstractmethod
    def __add__(self, other: Float or Integer or Complex) -> Float or Integer or Complex or Number:
    ...
    @abstractmethod
    def __mul__(self, other: 'Float' or Integer or Complex) -> Float or Integer or Complex:
    ...
    def checkType(self, other: Number or int or float, types: list[type] = None) -> None:
